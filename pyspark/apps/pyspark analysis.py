...
logs_df = spark.read.csv('/opt/spark-data/sample_logs.csv', header=True, schema=schema)
...
print(logs_df.filter(col('timestamp') >= '2024-09-01 00:00:00').count())
print('\n\n\n')

print('\n\nLog ERROR messages from September, 2024 upward...\n\n')
print('\n\n\n')
print('count of logs with ERRORS is...\n')
print(logs_df.filter((col('timestamp') >= '2024-09-01 00:00:00') & (col('level') == 'ERROR')).count())
print('\n\n\n')
